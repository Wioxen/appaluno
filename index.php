                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <ul class="list-group list-group-flush" style="margin-bottom: 0px;">
                                            ...
                                            <li id="cliqueNroSerie" class="list-group-item" style="border-bottom: 0px;">
                                                <small id="nroserie" style="color: white;">14</small>
                                                <i id="copy-nro-serie" class="fa fa-copy" style="float: right"></i>
                                            </li>
                                        </ul>
                                    </li>
                                    <!-- Menu Body -->
