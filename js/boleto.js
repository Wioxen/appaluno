...
function boletoClick(event) {
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: `https://api-boleto.digite.com.br/boletobancario?escola=${vEscola}&codigo=${vRM}&senhanet=${vSenhaNet}`,
        cache: false,        
        beforeSend: aguarda,
        error: function () {
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                $('#collapse' + index + ' .list-group-flush').append('<li class="list-group-item d-flex justify-content-between align-items-center">' +
                    ...
                    ' href="./url.ashx?codEscola=' + $("#codEscola").val() + '&url=https://boleto.digite.com.br/redirect.php?codEscola='+vEscola+'&codigo='+vRM+'&token='+value.token+'"><i class="fa fa-link"></i> Visualizar Boleto</a>' +
                    '</div> ' +
                    '</li>');
