var arrAgenda = ["SEQUÊNCIA", "ALMANAQUE"];
function exibeAtividade(data) {
    ...
    $.each(data, function (index, value) {
        if (arrAgenda.indexOf(value.Descricao.split(' ')[0]) != -1) {
...
function cliqueAtividade(event) {
