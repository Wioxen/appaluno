        ...
        success: function (data) {
            ...
            $.each($fields, function (index, value) {
                if (($('#grp' + value.GRUPO).length === 0) && (value.GRUPO !== '5')) {
                    ...
                    $('#table' + value.GRUPO + ' > thead').append('<th style="position: sticky;left:0px;text-align:left;background-color:#DBDBFF"><span style="margin-left: 10px;">DISCIPLINA</th></tr>');
            ...
            $.each($values, function (i, v) {
                $('.tbody').append('<tr class=' + v.DISCIPLINA + '>' +
                    '<td class="' + v.DISCIPLINA + '" style="position: sticky;left:0px;background-color: #fff;text-align:left;">' +
                    '<span>' + v.DDISCIPLINA + '</span>' +
                    '</td>' +
                    '</tr>');
            ...
            $.ajax({
                ...
                dataType: "json",
                url: "https://www.api.sistema2.com.br/WebApiSae/api/alunomenu?Escola=" + $escola + "&Codigo=" + $codigo + "&Ano=2023&Descricao=BOLETIM ESCOLAR",
                success: function (data) {
                    if (data !== null) {
